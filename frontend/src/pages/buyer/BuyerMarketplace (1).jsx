...
const RecommendChip = ({ p, onAdd, t, isDark }) => (
  <div style={{
    ...
    minWidth:220, flexShrink:0, transition:'transform 0.2s ease, box-shadow 0.2s ease, border-color 0.2s ease',
  }}
    ...
    <div style={{ flex:1, minWidth:0 }}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius:8, padding:'4px 12px', fontSize:12, fontWeight:700, cursor:'pointer', transition:'all 0.15s ease',
        }}
...
const BuyerMarketplace = () => {
  ...
  return (
    <div className="app-container" style={{ colorScheme: t.colorScheme }}>
      <Sidebar />
      <div className="main-content" style={{ position:'relative', background:t.pageBg, minHeight:'100vh', transition:'background 0.3s ease' }}>
        ...
        <div style={{ position:'relative', zIndex:1, padding:'0 24px 40px' }}>
          ...
          <div style={{ display:'flex', gap:10, marginBottom:24, flexWrap:'wrap', alignItems:'center' }}>
            <button
              ...
              style={{
                padding:'8px 18px', borderRadius:50, fontSize:13, fontWeight:600, cursor:'pointer', transition:'all 0.15s ease',
